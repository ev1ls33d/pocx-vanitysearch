...
// We use affine coordinates for elliptic curve point (ie Z=1)
 ...
 inline void CheckPoint(__private uint32_t *_h, int32_t incr, int32_t endo, int32_t mode,__global prefix_t *prefix,
  ...
  uint32_t   mi;
  uint32_t   lmi;
  uint32_t   tid = (get_group_id(0)*get_local_size(0)) + get_local_id(0);
  char       add[48];
...
#define CHECK_POINT_P2SH(_h,incr,endo,mode)  CheckPoint(_h,incr,endo,mode,prefix,lookup32,maxFound,out,P2SH)
 ...
 inline void CheckHashComp(__global prefix_t *prefix, __global uint64_t *px, uint8_t isOdd, int32_t incr,
 ...
 inline void CheckHashP2SHComp(__global prefix_t *prefix, __global uint64_t *px, uint8_t isOdd, int32_t incr,
  uint32_t *lookup32, uint32_t maxFound, uint32_t *out) {
...
// -----------------------------------------------------------------------------------------
 ...
 inline void CheckHashUncomp(__global prefix_t *prefix, __global uint64_t *px, __global uint64_t *py, int32_t incr,
                                             uint32_t *lookup32, uint32_t maxFound, uint32_t *out) {
 ...
 inline void CheckHashP2SHUncomp(__global prefix_t *prefix, __global uint64_t *px, __global uint64_t *py, int32_t incr,
  uint32_t *lookup32, uint32_t maxFound, uint32_t *out) {
...
// -----------------------------------------------------------------------------------------
 ...
 inline void CheckHash(uint32_t mode, __global prefix_t *prefix, __global uint64_t *px, __global uint64_t *py, int32_t incr,
                                       uint32_t *lookup32, uint32_t maxFound, uint32_t *out) {
 ...
 inline void CheckP2SHHash(uint32_t mode, prefix_t *prefix, uint64_t *px, uint64_t *py, int32_t incr,
  uint32_t *lookup32, uint32_t maxFound, uint32_t *out) {
...
// -----------------------------------------------------------------------------------------
 ...
 void ComputeKeys(uint32_t mode, __global uint64_t *startx, __global uint64_t *starty,
...
#define CHECK_PREFIX_P2SH(incr) CheckP2SHHash(mode, sPrefix, px, py, j*GRP_SIZE + (incr), lookup32, maxFound, out)
 ...
 void ComputeKeysP2SH(uint32_t mode, __global uint64_t *startx, __global uint64_t *starty,
  prefix_t *sPrefix, uint32_t *lookup32, uint32_t maxFound, uint32_t *out) {
...
CheckPoint(h2, -(_incr), 2, true, sPrefix, lookup32, maxFound, out, P2PKH);    \
 ...
 void ComputeKeysComp(__global uint64_t *startx, __global uint64_t *starty, prefix_t *sPrefix, __global uint32_t *lookup32, uint32_t maxFound, __global uint32_t *out) {
